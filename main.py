...
feature_male = mfcc_feature.extract(audio_male, SAMPLE_RATE)
feature_female = mfcc_feature.extract(audio_female, SAMPLE_RATE)
...
# X_test_features = np.array([mfcc_feature.extract(audio, sample_rate) for audio, sample_rate in X_test])
...
# new_sample_features = np.array([mfcc_feature.extract(new_sample_audio, new_sample_sample_rate)])
